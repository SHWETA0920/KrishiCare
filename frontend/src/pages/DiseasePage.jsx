...
function DiseasePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert(
        "AI Service is currently offline. Please check your backend connection.",
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-xl mx-auto">
          Upload a photo of your plant's leaf and our computer vision model will
          diagnose potential diseases and suggest treatments.
        </p>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl shadow-emerald-900/10 border border-gray-50">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            {preview ? (
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-500 font-medium">
                  Click to capture or upload leaf photo
                </p>
              </div>
            )}
          </label>
          ...
          <div className="space-y-6">
            <div className="bg-emerald-50 p-6 rounded-2xl border border-emerald-100">
              <h4 className="font-bold text-emerald-800 mb-2 underline decoration-emerald-200">
                Instructions:
              </h4>
        ...
        {data && (
          <ResultCard
            ...
            confidence={
              data?.confidence ? `${(data.confidence * 100).toFixed(1)}%` : null
            }
            type="disease"
          />
        )}
